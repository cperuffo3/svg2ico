...
- fab330a: fix: accept SVG files with leading comments before the root element
...
- 1a5c435: fix: multi-size PNG export now downloads a ZIP instead of a single PNG
...
- b6a541b: feat(api, web): Bucket admin daily counts and graphs in the viewer's timezone
