...
```css
--font-heading-1:
  2rem (32px), font-weight: 700 /* Page title */ --font-heading-2: 1.5rem (24px),
  font-weight: 600 /* Section headers */ --font-body: 1rem (16px),
  font-weight: 400 /* Body text */ --font-body-sm: 0.875rem (14px),
  font-weight: 400 /* Secondary text */ --font-caption: 0.75rem (12px),
  font-weight: 500 /* Labels, hints */;
```
